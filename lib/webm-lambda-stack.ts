...
export class WebmLambdaStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    this.handler = new lambda.Function(this, 'WebmHandler', {
      runtime: lambda.Runtime.NODEJS_22_X,
      handler: 'index.handler',
      code: lambda.Code.fromInline(`
        exports.handler = async (event) => {
          console.log('Processing WebM file:', JSON.stringify(event));
          return {
            statusCode: 200,
            body: 'Hello from WebM handler!'
          };
        };
      `),
    });
    ...
    // Add S3 notifications for WebM files
